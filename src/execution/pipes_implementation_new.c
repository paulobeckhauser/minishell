...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   pipes_implementation_new.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: sfrankie <sfrankie@student.42wolfsburg.    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/29 09:07:35 by pabeckha          #+#    #+#             */
/*   Updated: 2024/04/12 21:35:36 by sfrankie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pipes_implementation(t_info *structure)
{
	...
	// 			structure->table->in.fd = open(structure->table->in.file_name, O_RDONLY);
	// 			if (structure->table->in.fd == -1)
	// 			{
	// 				ft_putstr_fd("minishell: ", 2);
	// 				perror(structure->table->in.file_name);
	// 				exit(EXIT_FAILURE);
	// 			}
    ...
    //         {
	// 			if (structure->table->out.trunc)
	// 			{
	// 				structure->table->out.fd = open(structure->table->out.file_name,
